export const COVER_STORY =  [
    {
      id: 1,
      imgUrl: 'pictures/images/results/story-gallery/cover-story/cover_story_1.jpg',
      title: '一位兒童的奇幻旅程',
      text1:
        '一位在星火成長的孩子。他叫小瓜，面對缺乏家庭的挑戰，小瓜展現了驚人的勇氣和堅強的意志。他從小就夢想著飛翔，並努力學習、成長。透過故事藝廊，他分享了自己的親手堆疊出的積木城堡，展現出驚人的創造力和對愛的渴望。',
      text2:
        '小瓜的故事提醒著我們，每個孩子都擁有無限的潛力和夢想，只需要給予他們愛和支持的環境，他們就能像小鳥一樣自由自在地飛翔。'
    },
    {
      id: 2,
      ...
      title: '音樂的魔力',
      text1:
        '小妮是一位充滿音樂天賦的孤兒，卻因生活困難而無法接觸音樂。星火兒童協會舉辦了「音樂的魔力」工作坊，為孩子們提供音樂教育的機會。小妮參與了工作坊，她的心靈被音符所觸動，開啟了一個全新的世界。',
      text2:
        '在工作坊中，小妮學習唱歌的技巧，她的才華逐漸展露。音樂不僅讓她找到表達自己的方式，也給了她自信和希望。'
    }
  ];

  export const WARM_STORY = [
    {
      id: 1,
      ...
      title: '小手揉麵 共享美味',
      description:
        '小朋友們認真地學習製作麵包，彼此合作搓揉麵團，一同創造出美味的麵食作品。他們用小手捏出有趣的......'
    },
    {
      id: 2,
      ...
      title: '我是這樣長大的',
      description:
        '小安從小就以她的畫筆將奇幻的夢境和美麗的色彩帶入現實生活，她用繽紛的色彩和獨特的構圖展現她對......'
    },
    {
      id: 3,
      ...
      title: '禮物中的喜悅',
      description:
        '星火協會在兒童節這天，發放給每位小朋友們一份小禮物，這份禮物不僅帶來滿足，更加深愛與關懷的體......'
    },
    {
      id: 4,
      ...
      title: '萌萌的鐵道世界',
      description:
        '每當萌萌走進鐵道世界，他的眼睛就會閃耀著興奮的光芒。他會花上整個下午建設火車軌道、設置小火車......'
    },
    {
      id: 5,
      ...
      title: '大自然的奇妙旅程',
      description:
        '晴晴從學步起，就迷戀上大自然的美麗與神奇，總是迫不及待地探索著每一片草地、每一條小溪，她收集......'
    },
    {
      id: 6,
  ...
  export const PHOTO_ALBUM = [
    {
      ...
      title: '幸福的擁抱',
      description:
        '星火協會的愛心溫暖著心靈。在那一刻，他感受到無限的關懷，成為幸福的孩子，這份溫暖的擁抱將永遠留在他的回憶中，為他的成長之路點亮星火。'
    },
    {
      id: 2,
    ...
    },
    {
      ...
      title: '童年快樂時光',
      description:
        '小女孩充滿歡笑，童年。她與朋友們跳躍、奔跑，純真的笑容洋溢著臉上。他們一起探索自然，小女孩無拘束的自由，將童年時光點亮成美好的回憶。'
    }
  ];