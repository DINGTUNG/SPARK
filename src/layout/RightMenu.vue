...
<template>
  <div class="rightMenu">
    <ul>
        <li>
          <RouterLink to="/sponsor" class="link sponsor">
            <div class="icon">
                <img src="http://localhost:5173/chd102/g3/pictures/icons/right-menu/sponsor_icon.png" alt="領養icon">
            </div>
            我要認養</RouterLink>
        </li>
        <li @click="sponsorCartStore.showSideList">
                <div class="icon">
                    <img src="http://localhost:5173/chd102/g3/pictures/icons/right-menu/sponsor_list_icon.png" alt="領養清單icon">
                </div>
                認養清單
        </li>
        <li>
            <RouterLink to="/donate" class="link donate">
                <div class="icon">
                    <img src="http://localhost:5173/chd102/g3/pictures/icons/right-menu/donate_icon.png" alt="捐款icon">
                </div>
                我要捐款   
            </RouterLink>
        ...
        <li @click="donateCartStore.showSideList">
                <div class="icon">
                    <img src="http://localhost:5173/chd102/g3/pictures/icons/right-menu/donate_list_icon.png" alt="捐款清單icon">
                </div>
                捐款清單
        </li>
    </ul>
    <div class="other">
        <div class="icon">
            <img src="http://localhost:5173/chd102/g3/pictures/icons/right-menu/letter.png" alt="感謝信">
        </div>
        <div class="icon">
            <a href="https://m.me/sparkassociationorg" _blank>
                <img src="http://localhost:5173/chd102/g3/pictures/icons/right-menu/message.png" alt="message">
            </a>
        </div>
        <div class="icon">
