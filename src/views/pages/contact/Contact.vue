...
const contact = reactive([
  {
    ...
    localSrc: 'https://maps.google.com/maps?q=Taipei&t=&z=13&ie=UTF8&iwloc=&output=embed',
  },
  {
    index: 2,
    ...
    localSrc: 'https://maps.google.com/maps?q=New+York&t=&z=13&ie=UTF8&iwloc=&output=embed',
  },
  {
    index: 3,
    ...
    localSrc: 'https://maps.google.com/maps?q=London&t=&z=13&ie=UTF8&iwloc=&output=embed',
  },
  {
    index: 4,
    ...
    localSrc: 'https://maps.google.com/maps?q=Paris&t=&z=13&ie=UTF8&iwloc=&output=embed',
  },
]);
    ...
    <div class="main_body">
      ...
      <div class="contact_block">
        ...
        <div class="map">
          ...
          <iframe v-if="activeLocationIndex >= 0 && activeLocationIndex < contact.length"
            :src="contact[activeLocationIndex].localSrc" width="600" height="450" style="border:0;" allowfullscreen=""
