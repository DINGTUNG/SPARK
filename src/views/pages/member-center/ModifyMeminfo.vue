...
const getButtonStyle = (routePath) => {
      return {
        backgroundColor: route.path === routePath ? 'red' : 'blue',
    ...
    <div class="container">
        <div class="main_body">
            <div class="navigation_button_MB">
                <router-link :style="getButtonStyle('/adoption-record')" to="/adoption-record">認養紀錄</router-link>
                <router-link :style="getButtonStyle('/donate-record')" to="/donate-record">捐款紀錄</router-link>
                <router-link :style="getButtonStyle('/letter-record')" to="/letter-record">感謝函專區</router-link>
                <router-link :style="getButtonStyle('/modify-meminfo')" to="/modify-meminfo">修改會員資料</router-link>
            </div>
            <div class="main_form">
            <div class="title">
                <h1>修改基本資料</h1>
